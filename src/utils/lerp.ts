export const lerpFloat = (start: number, end: number, alpha: number): number => (1 - alpha) * start + alpha * end;
 ...
 */
export const lerpHexRGB = (start: number, end: number, alpha: number): number => {
